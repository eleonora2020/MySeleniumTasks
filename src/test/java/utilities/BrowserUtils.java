...
public class BrowserUtils {
    ...
    public static void clickWithJS(WebElement element) {
        ((JavascriptExecutor) utils.Driver.get()).executeScript("arguments[0].scrollIntoView(true);", element);
        ((JavascriptExecutor) utils.Driver.get()).executeScript("arguments[0].click();", element);
    }
    ...
    public static WebElement waitForClickablility(WebElement element, int timeout) {
        WebDriverWait wait = new WebDriverWait(utils.Driver.get(), timeout);
